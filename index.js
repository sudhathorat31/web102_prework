...
function filterUnfundedOnly() {
    ...
    console.log(unfundedGames); // Debugging line to see how many are returned
...
function filterFundedOnly() {
    ...
    console.log(fundedGames); // Debugging to count
...
// Assume these values have already been calculated:
...
const displayStr = `A total of $${formattedRaised} has been raised for ${totalGames} games. Currently, ${unfundedGames} ${gameWord} remain unfunded. We need your help to fund these amazing games!`;
...
topGameElement.textContent = topFundedGame;
firstGameContainer.appendChild(topGameElement);
// do the same for the runner up item
const secondMostFundedGame = secondGame.name;
const secondGameElement = document.createElement('div');
secondGameElement.textContent = secondMostFundedGame;
